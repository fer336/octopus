/**
 * Modal de confirmación para eliminar múltiples marcas.
 */
import { useState } from 'react'
import { AlertTriangle, Trash2, X } from 'lucide-react'
import { Modal, Button } from '../ui'

interface BulkDeleteBrandModalProps {
  isOpen: boolean
  onClose: () => void
...
export default function BulkDeleteBrandModal({
  isOpen,
  onClose,
  onConfirm,
  count,
}: BulkDeleteBrandModalProps) {
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="mb-1 text-sm font-medium text-red-900 dark:text-red-200">
                Se eliminarán {count} marca{count === 1 ? '' : 's'}.
              </p>
              <p className="text-xs text-red-700 dark:text-red-400">
                Si alguna marca tiene productos asociados, el backend bloqueará la eliminación,
